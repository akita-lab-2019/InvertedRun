...
private:
    ...
    float m_forward_list[15] = {115, 120, 120, 105, 87, 90, 100, 105, 110, 120, 110, 105, 100, 105, 120};
    ...
    float m_distance_list[15] = {0.60, 1.25, 1.70, 2.45, 3.30, 3.95, 4.60, 4.65, 5.55, 6.35, 6.95, 7.05, 7.60, 8.95, 9.25};
