...
private:
    ...
    // 前進量リスト
    float m_forward_list[15] = {110, 115, 120, 100, 100, 100, 100, 107, 115, 120, 105, 98, 100, 115, 120};

    // 曲率旋回量リスト
    float m_curvature_list[4] = {0, 10, 11, 14};

    // PID係数リスト
    float m_trace_pid_list[4][3] = {{0.360, 0.000, 0.028},
                                    {0.450, 0.000, 0.035},
                                    {0.500, 0.000, 0.038},
                                    {0.530, 0.000, 0.041}};
    ...
    int m_is_curve_list[15] = {0, 2, 0, 1, 3, 3, 3, 0, 1, 0, 1, 1, 2, 3, 0};
};
