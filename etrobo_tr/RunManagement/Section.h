...
private:
    ...
    float m_forward_list[15] = {115, 120, 120, 105, 95, 90, 100, 105, 110, 115, 100, 105, 95, 100, 120};
    ...
    float m_distance_list[15] = {0.60, 1.25, 1.70, 2.45, 3.30, 3.95, 4.60, 4.70, 5.55, 6.35, 7.10, 7.10, 7.55, 9.00, 9.25};
    // float m_distance_list[15] = {0.60, 1.25, 1.70, 2.45, 3.30, 4.00, 4.60, 4.70, 5.55, 6.4\5,\ 7.00, 7.05, 7.60, 8.95, 0.3};
