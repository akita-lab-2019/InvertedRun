...
private:
    ...
    float m_color_target = 32.0; // カラーセンサの目標値
    ...
    // 前進量リスト
    float m_forward_list[15] = {105, 110, 110, 105, 100, 95, 110, 114, 116, 120, 115, 110, 110, 105, 120};

    // 曲率旋回量リスト
    float m_curvature_list[5] = {0, 0, 0, 0, 0};

    // PID係数リスト
    float m_trace_pid_list[5][3] = {{0.400, 0.000, 0.031},
                                    {0.600, 0.000, 0.047},
                                    {0.650, 0.000, 0.050},
                                    {0.850, 0.000, 0.066},
                                    {0.500, 0.000, 0.039}};
    ...
    // 曲率分類リスト（それぞれの区間がその曲率分類に属しているかをリストアップしている）
    int m_is_curve_list[15] = {0, 2, 0, 1, 3, 3, 2, 0, 1, 0, 1, 0, 3, 3, 0};
