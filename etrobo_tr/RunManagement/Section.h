...
private:
    ...
    // 前進量リスト
    float m_forward_list[15] = {105, 110, 115, 110, 100, 105, 103, 107, 115, 120, 105, 100, 100, 105, 115};
    ...
    float m_distance_list[15] = {0.60, 1.25, 1.70, 2.45, 3.30, 4.00, 4.60, 4.70, 5.55, 6.45, 6.99, 7.045, 7.60, 8.95, 9.25};
