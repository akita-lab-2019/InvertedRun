...
private:
    ...
    // // // 前進量リスト
    float m_forward_list[15] = {110, 115, 113, 105, 100, 100, 110, 113, 116, 120, 115, 115, 115, 116, 120};

    // // // 曲率旋回量リスト
	float m_curvature_list[15] = {0, 11.4, 0, 10.3, 15.6, 15.6, 11.4, 0, 10.3, 0, 10.3, 10, 11.4, 11.4, 0};
    ...
    // PID係数リスト
     float m_trace_pid_list[15][3] = {{0.300, 0.000, 0.023},  // 0
                                      ...
                                      {0.450, 0.000, 0.035},  // 8"
                                      {0.300, 0.000, 0.023},  // 9
                                      {0.450, 0.000, 0.035},  // 10"
                                      {0.300, 0.000, 0.023},  // 11
                                      {0.515, 0.100, 0.040},  // 12
                                      {0.515, 0.100, 0.040},  // 13"
                                      {0.300, 0.000, 0.023}}; // 14
   // float m_trace_pid_list[15][3] = {{0.300, 0.000, 0.023},
   //                                  {0.450, 0.000, 0.035},
   //                                  {0.515, 0.100, 0.040},
   //                                  {0.600, 0.100, 0.055},
   //                                  {0.500, 0.000, 0.039}};
    ...
    // // // 区間終了距離（それぞれの区間がスタートから何mの地点で終わるのかをリストアップしている）
    float m_distance_list[15] = {0.60, 1.24, 1.68, 2.43, 3.30, 4.05, 4.60, 4.69, 5.56, 6.45, 7.01, 7.25, 7.53, 8.95, 9.25};
