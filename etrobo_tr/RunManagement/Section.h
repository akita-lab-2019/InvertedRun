...
private:
    ...
    // 曲率旋回量リスト
    float m_curvature_list[15] = {0, 11, 0, 10, 14.2, 14.2, 11, 0, 10, 0, 10, 0, 11, 14.2, 0};

    // PID係数リスト
    float m_trace_pid_list[15][3] = {{0.300, 0.000, 0.038},  // 0
                                     {0.485, 0.000, 0.065},  // 1
                                     {0.300, 0.000, 0.038},  // 2
                                     {0.460, 0.000, 0.050},  // 3"
                                     {0.550, 0.100, 0.070},  // 4"
                                     ...
                                     {0.460, 0.000, 0.050},  // 8
                                     {0.300, 0.000, 0.038},  // 9
                                     {0.460, 0.000, 0.050},  // 10
                                     {0.300, 0.000, 0.038},  // 11
                                     {0.485, 0.000, 0.065},  // 12
                                     {0.550, 0.100, 0.070},  // 13
                                     {0.300, 0.000, 0.038}}; // 14

    // カラーセンサの目標値リスト
    // float m_color_target_list[5] = {28.0, 29.0, 30.0, 31.0, 32.0};
    ...
    // カラーセンサ目標値分類リスト
    // int m_is_coler_target_list[15] = {2, 1, 1, 1, 0, 4, 3, 3, 3, 2, 3, 3, 3, 0, 1};
