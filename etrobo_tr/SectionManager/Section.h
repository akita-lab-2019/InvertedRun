...
private:
    ...
    float m_curvature_list[18] = {0, 14.5, 0, 13.0, 18.0, 22.0, -16.5, -14.5, 0, -10, 0, -12.5, 0, -14.5, 0, 14.5, 0, 0};

    float m_distance_list[18] = {0.68, 1.3, 1.80, 2.57, 2.65, 3.4, 4.09, 4.69, 4.87, 5.64, 6.51, 7.17, 7.32, 7.5, 7.61, 9.03, 9.4, 10.07};
};
